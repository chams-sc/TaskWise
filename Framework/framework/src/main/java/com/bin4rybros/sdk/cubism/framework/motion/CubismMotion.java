...
import com.bin4rybros.sdk.cubism.framework.math.CubismMath;
import com.bin4rybros.sdk.cubism.framework.model.CubismModel;
...
public final class CubismMotion extends ACubismMotion {
    ...
    public void setParameterFadeInTime(CubismId parameterId, float value) {
        for (int i = 0; i < motionData.curves.size(); i++) {
            CubismMotionInternal.CubismMotionCurve curve = motionData.curves.get(i);
    ...
    public List<String> getFiredEvent(float beforeCheckTimeSeconds, float motionTimeSeconds) {
        if (areFiredEventValuesChanged) {
            ...
            for (int i = 0; i < motionData.events.size(); i++) {
                CubismMotionInternal.CubismMotionEvent event = motionData.events.get(i);
    ...
    public boolean isExistModelOpacity() {
        for (int i = 0; i < motionData.curves.size(); i++) {
            ...
            if (curve.type != CubismMotionInternal.CubismMotionCurveTarget.MODEL) {
                continue;
            }
    ...
    public CubismId getModelOpacityId(int index) {
        ...
        CubismMotionInternal.CubismMotionCurve curve = motionData.curves.get(index);
    ...
    protected void doUpdateParameters(
        ...
        List<CubismMotionInternal.CubismMotionCurve> curves = motionData.curves;
        ...
        for (int i = 0; i < curves.size(); i++) {
            CubismMotionInternal.CubismMotionCurve curve = curves.get(i);
        ...
        for (int i = 0; i < curves.size(); i++) {
            ...
            if (curve.type != CubismMotionInternal.CubismMotionCurveTarget.PARAMETER) {
                continue;
            }
        ...
        for (int i = 0; i < curveSize; i++) {
            ...
            if (curve.type != CubismMotionInternal.CubismMotionCurveTarget.PART_OPACITY) {
                continue;
            }
    ...
    private class LinearEvaluator implements CubismMotionInternal.CsmMotionSegmentEvaluationFunction {
        @Override
        public float evaluate(float time, int basePointIndex) {
            CubismMotionInternal.CubismMotionPoint p0 = motionData.points.get(basePointIndex);
            CubismMotionInternal.CubismMotionPoint p1 = motionData.points.get(basePointIndex + 1);
    ...
    private class BezierEvaluator implements CubismMotionInternal.CsmMotionSegmentEvaluationFunction {
        @Override
        public float evaluate(final float time, final int basePointIndex) {
            final CubismMotionInternal.CubismMotionPoint p0 = motionData.points.get(basePointIndex);
            final CubismMotionInternal.CubismMotionPoint p1 = motionData.points.get(basePointIndex + 1);
            final CubismMotionInternal.CubismMotionPoint p2 = motionData.points.get(basePointIndex + 2);
            final CubismMotionInternal.CubismMotionPoint p3 = motionData.points.get(basePointIndex + 3);
    ...
    private class BezierEvaluatorCardanoInterpretation implements CubismMotionInternal.CsmMotionSegmentEvaluationFunction {
        @Override
        public float evaluate(final float time, final int basePointIndex) {
            CubismMotionInternal.CubismMotionPoint p0 = motionData.points.get(basePointIndex);
            CubismMotionInternal.CubismMotionPoint p1 = motionData.points.get(basePointIndex + 1);
            CubismMotionInternal.CubismMotionPoint p2 = motionData.points.get(basePointIndex + 2);
            CubismMotionInternal.CubismMotionPoint p3 = motionData.points.get(basePointIndex + 3);
    ...
    private class SteppedEvaluator implements CubismMotionInternal.CsmMotionSegmentEvaluationFunction {
        @Override
        public float evaluate(float time, int basePointIndex) {
    ...
    private class InverseSteppedEvaluator implements CubismMotionInternal.CsmMotionSegmentEvaluationFunction {
        @Override
        public float evaluate(final float time, final int basePointIndex) {
    ...
    private static CubismMotionInternal.CubismMotionPoint lerpPoints(
        final CubismMotionInternal.CubismMotionPoint a,
        final CubismMotionInternal.CubismMotionPoint b,
        final float t,
        CubismMotionInternal.CubismMotionPoint motionPoint
    ) {
     ...
     */
    private boolean existFadeIn(CubismMotionInternal.CubismMotionCurve curve) {
     ...
     */
    private boolean existFadeOut(CubismMotionInternal.CubismMotionCurve curve) {
     ...
     */
    private boolean existFade(CubismMotionInternal.CubismMotionCurve curve) {
    ...
    private void parse(byte[] motionJson) {
        motionData = new CubismMotionInternal.CubismMotionData();
        ...
        motionData.curves = new ArrayList<CubismMotionInternal.CubismMotionCurve>(motionData.curveCount);
        for (int i = 0; i < motionData.curveCount; i++) {
            motionData.curves.add(new CubismMotionInternal.CubismMotionCurve());
        }

        motionData.segments = new ArrayList<CubismMotionInternal.CubismMotionSegment>(json.getMotionTotalSegmentCount());
        for (int i = 0; i < json.getMotionTotalSegmentCount(); i++) {
            motionData.segments.add(new CubismMotionInternal.CubismMotionSegment());
        }

        motionData.points = new ArrayList<CubismMotionInternal.CubismMotionPoint>(json.getMotionTotalPointCount());
        for (int i = 0; i < json.getMotionTotalPointCount(); i++) {
            motionData.points.add(new CubismMotionInternal.CubismMotionPoint());
        }

        motionData.events = new ArrayList<CubismMotionInternal.CubismMotionEvent>(motionData.eventCount);
        for (int i = 0; i < motionData.eventCount; i++) {
            motionData.events.add(new CubismMotionInternal.CubismMotionEvent());
        }
        ...
        for (int curveCount = 0; curveCount < motionData.curveCount; curveCount++) {
            final CubismMotionInternal.CubismMotionCurve curve = motionData.curves.get(curveCount);
            ...
            if (targetName.equals(TargetName.MODEL.name)) {
                curve.type = CubismMotionInternal.CubismMotionCurveTarget.MODEL;
            } else if (targetName.equals(TargetName.PARAMETER.name)) {
                curve.type = CubismMotionInternal.CubismMotionCurveTarget.PARAMETER;
            } else if (targetName.equals(TargetName.PART_OPACITY.name)) {
                curve.type = CubismMotionInternal.CubismMotionCurveTarget.PART_OPACITY;
            } else {
            ...
            for (int segmentPosition = 0; segmentPosition < json.getMotionCurveSegmentCount(curveCount); ) {
                ...
                CubismMotionInternal.CubismMotionSegmentType segmentType = null;

                if (tmpSegment == 0) {
                    segmentType = CubismMotionInternal.CubismMotionSegmentType.LINEAR;
                } else if (tmpSegment == 1) {
                    segmentType = CubismMotionInternal.CubismMotionSegmentType.BEZIER;
                } else if (tmpSegment == 2) {
                    segmentType = CubismMotionInternal.CubismMotionSegmentType.STEPPED;
                } else if (tmpSegment == 3) {
                    segmentType = CubismMotionInternal.CubismMotionSegmentType.INVERSESTEPPED;
                } else {
                    assert (false);
                }
                ...
                switch (segmentType) {
                    case LINEAR: {
                        CubismMotionInternal.CubismMotionSegment segment = motionData.segments.get(totalSegmentCount);
                        segment.segmentType = CubismMotionInternal.CubismMotionSegmentType.LINEAR;
                        segment.evaluator = linearEvaluator;

                        CubismMotionInternal.CubismMotionPoint point = motionData.points.get(totalPointCount);
                    ...
                    case STEPPED: {
                        motionData.segments.get(totalSegmentCount).segmentType = CubismMotionInternal.CubismMotionSegmentType.STEPPED;
                    ...
                    case INVERSESTEPPED: {
                        motionData.segments.get(totalSegmentCount).segmentType = CubismMotionInternal.CubismMotionSegmentType.INVERSESTEPPED;
    ...
    private float getLerpPointsValue(
        CubismMotionInternal.CubismMotionPoint p0,
        CubismMotionInternal.CubismMotionPoint p1,
        CubismMotionInternal.CubismMotionPoint p2,
        CubismMotionInternal.CubismMotionPoint p3,
        float t
    ) {
    ...
    private float evaluateCurve(final CubismMotionInternal.CubismMotionCurve curve, final float time) {
        ...
        for (int i = curve.baseSegmentIndex; i < totalSegmentCount; i++) {
            ...
            pointPosition = motionData.segments.get(i).basePointIndex
                + (motionData.segments.get(i).segmentType == CubismMotionInternal.CubismMotionSegmentType.BEZIER
                   ? 3
                   : 1);
        ...
        final CubismMotionInternal.CubismMotionSegment segment = motionData.segments.get(target);
