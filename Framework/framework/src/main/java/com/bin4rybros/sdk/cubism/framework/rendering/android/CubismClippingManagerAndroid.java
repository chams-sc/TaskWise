...
package com.bin4rybros.sdk.cubism.framework.rendering.android;
...
import com.bin4rybros.sdk.cubism.framework.type.csmRectF;
...
class CubismClippingManagerAndroid implements Closeable {
    ...
    private void calcClippedDrawTotalBounds(CubismModel model, CubismClippingContext clippingContext) {
        ...
        for (int clippedDrawableIndex = 0; clippedDrawableIndex < clippedDrawCount; clippedDrawableIndex++) {
            ...
            int loop = drawableVertexCount * CubismFramework.VERTEX_STEP;
            for (int pi = CubismFramework.VERTEX_OFFSET; pi < loop; pi += CubismFramework.VERTEX_STEP) {
