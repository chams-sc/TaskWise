...
import static com.bin4rybros.sdk.cubism.framework.rendering.android.CubismShaderPrograms.*;
...
class CubismShaderAndroid {
    ...
    private int loadShaderProgram(final String vertShaderSrc, final String fragShaderSrc) {
        ...
        if (!linkProgram(shaderProgram)) {
            CubismDebug.cubismLogError("Failed to link program: " + shaderProgram);
    ...
    private boolean linkProgram(int shaderProgram) {
        ...
        if (logLength[0] > 0) {
            ...
            CubismDebug.cubismLogError("Program link log: " + log);
        }
    ...
    private boolean validateProgram(int shaderProgram) {
        ...
        if (logLength[0] > 0) {
            String log = glGetProgramInfoLog(shaderProgram);
            CubismDebug.cubismLogError("Validate program log: " + log);
        }
